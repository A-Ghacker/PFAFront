    ...
    return (
        ...
        >
            <div className={classes.drawerContainer}>
                <List>
                    <ListItem button component={Link} to="/profileProjectManger" className={classes.listItem}>
                        <ListItemIcon>
                            <DashboardIcon />
                        </ListItemIcon>
                        <ListItemText primary="Profile" />
                    </ListItem>
                    <ListItem button component={Link} to="/ProjectManagerProjects" className={classes.listItem}>
                        <ListItemIcon>
                            <AccountCircleIcon />
                        </ListItemIcon>
...
export default ProjectManagerSideNav